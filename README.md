...
# DL-DiscoMT - Tamil to Kannada MT 

 This project provides a translation model that converts Tamil text into Kannada. It is built to facilitate smooth and accurate translation between these two languages. The model has been optimized using CTranslate2, which allows it to run efficiently and provides a compact model file suitable for deployment in various environments. This project is ideal for developers and organizations needing language translation support for Tamil and Kannada in their applications.
   
## Download - Model

Download the model from the provided drive link: 

   [https://drive.google.com/drive/folders/1prRbfS1VQeB4zrP6F47TUs75XxtIgj2U?usp=sharing](https://drive.google.com/drive/folders/1prRbfS1VQeB4zrP6F47TUs75XxtIgj2U?usp=sharing)
...
gdown --folder https://drive.google.com/drive/folders/1prRbfS1VQeB4zrP6F47TUs75XxtIgj2U?usp=sharing
...
## windows
   ...
   docker build -t <Image Name> <basepath/Tam-Kan-NMT-AUKBC-ULCA-Deploy/>
```
Or on Ubuntu:
```bash
## ubuntu

   sudo docker build -t <Image Name> <basepath/Tam-Kan-NMT-AUKBC-ULCA-Deploy/>
```
...
## Screenshots
input :"கவுதம் கம்பீர் மற்றும் கோலி இடையே விரிசல் இருப்பதாக ஒரு வதந்தி உள்ளது"
<br>
![App Screenshot](https://github.com/dldiscomt/DL-DiscoMT-TamKan/blob/main/output/takapicture.jpg?raw=true)
